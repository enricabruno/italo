...
By adopting the XD methodology, the project is built on the alignment of [ODI]([https://link-al-progetto.org](https://odi-documentation.github.io/materials/) (Ontologia dei Destini Incrociati), a customised ontology developed for the description and representation of Calvino's *macchina narrativa combinatoria* of the first collection of *Il castello dei destini incrociati*. Specifically, ODI is aligned following this structure: 
